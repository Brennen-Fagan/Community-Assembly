...
parameters <- c(0.01, 10^(1/3), 0.5, 0.2, 100, 0.1) 
# Preferred predation ratio 10 means consumer - basal
# Preferred predation ratio 10^(1/n) should result in multiple consumer-consumer interactions (2n with log body sizes -1 to 1) before a basal species comes up.
