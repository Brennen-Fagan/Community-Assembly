...
# For this version, the environmental coefficient of variation k6 is 0.2.
...
systemMods <- list(
  ...
  InteractionsNoiseMultiplier = c(1, 1, 1, 1, 0, 2)
)
...
systemMods$SpaceDistanceMultiplier <- 10^c(Inf, 9:0)
...
stopifnot(sum(sapply(cases, nrow)) == 11)
