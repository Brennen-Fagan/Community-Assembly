...
Increasing the dispersal rate (0.001 to 0.1) and decreasing the elimination tolerance (0.1 to 0.001) produces behaviour that is more similar to what we had before, although the magnitudes of the abundances do differ. This is not always the case; the 4th system goes from colonies to domination, although this does not seem necessarily wrong. Looking back at the larger time step system that I am expecting, the values we were hitting are below the default tolerance, which suggests they should have been eliminated anyways.
(This behaviour seems to suggest that the event triggers, then the integration occurs, then the result is reported, which seems a bit strange to be honest.)
Naturally, the timings appear to be different as well.
