...
if (version == 1) {
  ...
  source(paste0(
    "LawMorton1996-NumericalPoolCommunityScaling-Settings", version, ".R"
  ))
}
```
...
if (export_calculation) {
  filenameExported <- if (version == 1) {
    "LawMorton1996-NumericalPoolCommunityScaling-PoolMats.RDS"
  } else {
    paste0("LawMorton1996-NumericalPoolCommunityScaling-PoolMats", version, ".RDS")
  }
  save(
