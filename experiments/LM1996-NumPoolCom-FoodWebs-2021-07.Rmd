...
```{r gallery02}
toPostMortem(foodWebs[[28]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
...
### Invadable
```{r gallery03}
toPostMortem(foodWebs[[41]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
...
### Does Not Persist
```{r gallery04}
toPostMortem(foodWebs[[61]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
...
### Hybrid
```{r gallery05}
toPostMortem(foodWebs[[81]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
...
### Largest Assembled
```{r gallery06}
toPostMortem(foodWebs[[27]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
...
### Largest Hybrid
```{r gallery07}
toPostMortem(foodWebs[[75]], nodeSize = "None", threshold = thresholdEdges) -> temp
```
```{r}
temp
```
