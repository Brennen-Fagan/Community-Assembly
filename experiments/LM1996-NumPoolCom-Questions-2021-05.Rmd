...
#                                 level = "LongWeightedTrophicLevel"))
sideBySideGainLoss(foodWebs[[86]], nodeSize = "None", threshold = 0.1)
```
...
#                                 level = "LongWeightedTrophicLevel"))
sideBySideGainLoss(foodWebs[[92]], nodeSize = "None", threshold = 0.1)
```

#### Largest Assembled
```{r gallery6}
sideBySideGainLoss(foodWebs[[33]], nodeSize = "None", threshold = 0.1)
```

#### Largest Hybrid
```{r gallery7}
sideBySideGainLoss(foodWebs[[87]], nodeSize = "None", threshold = 0.1)
```
...
save(
  ...
  islandInteractionsOneEmptyTwo, # Outcomes of three island interactions.
  islandInteractionsOneEmptyTwoWhich, # Which species are present per island.
  islandInteractionsOneTwo, # Outcomes of two island interactions.
  islandInteractionsOneTwoWhich, # Which species are present per island.
